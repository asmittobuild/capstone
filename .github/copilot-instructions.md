...
- TypeScript 5.x (strict mode) + React 18 + Vite 5, Tailwind CSS 3, DOMPurify, react-router-dom, @supabase/supabase-js, uuid (001-pokefusions-core)
- Supabase (Postgres) for fusion data + images via `@supabase/supabase-js`; browser localStorage for user settings (API token, model ID, theme) (001-pokefusions-core)
...
## Recent Changes
- 001-pokefusions-core: Added TypeScript 5.x (strict mode) + React 18 + Vite 5, Tailwind CSS 3, DOMPurify, react-router-dom, @supabase/supabase-js, uuid
